                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-custom">
                        <div class="single-footer-widget m-0">
                            ...
                            <p class="desc-content">DND Bicycle Shop - A hundred suitable bicycles for you.</p>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-custom">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <address>97 Man Thien Street, Thu Duc City,<br> Ho Chi Minh City.<br>Phone: 098 1625 777<br>Email: dntbicycleshop@gmail.com</address>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 text-center col-custom">
                        <div class="copyright-content">
                            <p> <a href="n18dccn226@student.ptithcm.edu.vn" title="dntbicycleshop@gmail.com">DNT BICYCLE SHOP</a>
								| Built with&nbsp;<strong>Bicycle Shop</strong>&nbsp;by <a href="dntbicycleshop@gmail.com" title="dntbicycleshop@gmail.com">DND Group</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
