				...
				<div class="col-12 col-custom widget-mt">
					...
					<div class="shop_toolbar_wrapper mb-30">
						<div class="shop_toolbar_btn">
							<button data-role="grid_4" type="button"
								class="active btn-grid-4" title="Grid-4">
								<i class="fa fa-th"></i>
							</button>
					...
					<div class="row shop_wrapper grid_4">
						<c:forEach var="flo" items="${pagedListHolder.pageList}">
								...
								<div class="product-item">
									<div class="single-product position-relative mr-0 ml-0">
										<div class="product-image">
											<a class="d-block"
												href="${pageContext.request.contextPath}/shop/product_detail/${flo.id}.htm">
												<img
												src="${pageContext.request.contextPath}/resources/images/bicycle/${flo.image}"
											...
											<div class="add-action d-flex flex-column position-absolute">
												<a title="Compare"> <i class="lnr lnr-sync"
													...
													title="Wishlist"></i>
												</a> <a href="#exampleModalCenter${flo.id}" title="Quick View"
													data-toggle="modal"
													data-target="#exampleModalCenter${flo.id}"> <i
													class="lnr lnr-eye" data-toggle="tooltip"
										...
										<div class="product-content">
											<div class="product-title">
												<h4 class="title-2">
													<a
														href="${pageContext.request.contextPath}/shop/product_detail/${flo.id}.htm">${flo.name}</a>
												</h4>
											</div>
											...
											<div class="price-box">
												<c:if test="${flo.discount==0 || flo.discount==null }">
													<span class="regular-price "><fmt:formatNumber
															pattern="###,### VND" value="${flo.price}"
															type="currency" /></span>
												</c:if>
												<c:if test="${flo.discount!=0 && flo.discount!=null }">
													<span class="regular-price "><fmt:formatNumber
															pattern="###,### VND"
															value="${flo.price - (flo.price*flo.discount)/100 }"
															type="currency" /> </span>
													<del>
											...
											<c:if test="${userLogin!=null}">
												<a
													href="${pageContext.request.contextPath}/shop/cart/insert/${flo.id}.htm"
													class="btn product-cart">Add to Cart</a>
											</c:if>
										</div>
										<div class="product-content-listview">
											...
											<div class="button-listview">
												...
												<a class="list-icon" title="Compare"> <i
													class="lnr lnr-sync" data-toggle="tooltip"
													data-placement="top" title="Compare"></i>
												</a> <a class="list-icon" title="Add To Wishlist"> <i
													class="lnr lnr-heart" data-toggle="tooltip"
							...
							<!-- Modal -->
							<div class="modal flosun-modal fade"
								id="exampleModalCenter${flo.id}" tabindex="-1" role="dialog"
								aria-hidden="true">
																		...
																		<div class="add-to_btn">
																			...
																			<c:if test="${userLogin!=null}">
																				<input
																					...
																					type="submit"
																					formaction="${pageContext.request.contextPath}/shop/cart/insert/${flo.id}.htm"
																					value="Add to cart">
																			</c:if>
																			<a class="btn flosun-button secondary-btn rounded-0">Add
																				to wishlist</a>
																		</div>
																	</div>
																</div>
