									...
									<c:forEach var="cart" items="${carts}">
										<tr>
											<td class="pro-thumbnail"><a href="#"><img
													...
													alt="Product" /></a></td>
											<td class="pro-title"><a href="#">${cart.bicycle.name}</a></td>
											...
											<td class="pro-quantity">
												<div class="quantity">
													<div class="cart-plus-minus">
														<input class="cart-plus-minus-box" name="qtt${cart.id}"
											...
											<td class="pro-subtotal"><span><fmt:formatNumber
														pattern="###,### VND" value="${cart.amount*cart.quantity}"
														type="currency" /></span></td>
											<td class="pro-remove"><a
												href="${pageContext.request.contextPath}/shop/cart/delete/${cart.id}.htm"><i
						...
						<div
							...
							<div class="apply-coupon-wrapper">
								<a href="${pageContext.request.contextPath}/shop/main.htm"
									class="btn flosun-button primary-btn rounded-0 black-btn">Shop
									Collection</a>
							</div>
						</div>
					</form:form>
			...
			<div class="row">
				<div class="col-lg-5 ml-auto col-custom">
					...
					<div class="cart-calculator-wrapper">
						...
						<a href="${pageContext.request.contextPath}/shop/checkout.htm"
