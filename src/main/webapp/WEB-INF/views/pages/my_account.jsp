							...
							<div class="col-lg-3 col-md-4 col-custom">
								<div class="myaccount-tab-menu nav" role="tablist">
									<a href="#dashboad" class="active" data-toggle="tab"><i
										...
										Orders</a> <a href="#payment-method" data-toggle="tab"><i
										class="fa fa-credit-card"></i> Payment Method</a> <a
										href="#account-edit" data-toggle="tab"><i
										class="fa fa-user"></i> Account Details</a> <a href="#password"
										data-toggle="tab"><i class="fa fa-key"></i> Change
										Password</a> <a
										href="${pageContext.request.contextPath}/pages/logout.htm"><i
								...
								<div class="tab-content" id="myaccountContent">
									...
									<div class="tab-pane fade show active" id="dashboad"
										...
										<div class="myaccount-content">
											...
											<div class="welcome">
												<p>
													Hello, <strong>${userLogin.name}</strong> (If Not <strong>${userLogin.name}
														!</strong><a
														href="${pageContext.request.contextPath}/pages/logout.htm"
													...
													<tbody>
														<c:forEach var="trans" items="${Trans}">
															<tr>
																...
																<td><a
																	href="${pageContext.request.contextPath}/pages/my_account/userOrders/${trans.id}.htm"
																	class="btn flosun-button secondary-btn theme-color  rounded-0">View</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
									...
									<div class="tab-pane fade" id="account-edit" role="tabpanel">
										<div class="myaccount-content">
											...
											<div class="account-details-form">
												<form:form
													action="${pageContext.request.contextPath}/pages/my_account/update.htm"
													method="post">
													<div class="row">
														...
														<div class="col-lg-6 col-custom">
															<div class="single-input-item mb-3">
																<label for="phone" class="required mb-1">Phone</label> <input
									...
									<div class="tab-pane fade" id="password" role="tabpanel">
										<div class="myaccount-content">
											...
											<div class="account-details-form">
												<form:form
													action="${pageContext.request.contextPath}/pages/my_account/changePassword.htm"
													method="post">
													<fieldset>
														<div class="single-input-item mb-3">
															<label for="current-pwd" class="required mb-1">Current
																Password</label> <input type="password" id="current-pwd"
																name="current-pwd" placeholder="Current Password" />
														</div>
														<div class="row">
															<div class="col-lg-6 col-custom">
																<div class="single-input-item mb-3">
																	<label for="new-pwd" class="required mb-1">New
																		...
																		name="new-pwd" placeholder="New Password" />
																</div>
															</div>
															<div class="col-lg-6 col-custom">
																<div class="single-input-item mb-3">
																	<label for="confirm-pwd" class="required mb-1">Confirm
																		...
																		name="confirm-pwd" placeholder="Confirm Password" />
																</div>
															</div>
														</div>
													</fieldset>
