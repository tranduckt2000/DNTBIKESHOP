				...
				<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
					<div class="login-register-wrapper">
						<div class="section-content text-center mb-5">
							...
							<p class="desc-content">Please login using account detail
								bellow.</p>
						</div>
						<!-- Xử Lý Form login  -->
						<div class="mb-3" style="color: red">${message}</div>
						<form:form
							action="${pageContext.request.contextPath}/pages/login.htm"
							...
							<div class="single-input-item mb-3">
								<div
									...
									<a
										href="${pageContext.request.contextPath}/pages/forgotPassword.htm"
										class="forget-pwd mb-3">Forget Password?</a>
								</div>
							</div>
							<div class="single-input-item mb-3">
								<button
							...
							<div class="single-input-item">
								<a href="${pageContext.request.contextPath}/pages/register.htm">Create
									Account</a>
							</div>
						</form:form>
					</div>
